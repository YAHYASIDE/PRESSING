...
const ROLES={
  manager: {label:"مدير",   tabs:["dashboard","pos","cars","crm","carpets","expenses","reports","accounting","inventory"], caps:{settings:1,delete:1,workers:1,finance:1,receive:1,operate:1,collect:1}},
  admin:   {label:"مسؤول",  tabs:["dashboard","pos","cars","crm","carpets","expenses","reports","accounting","inventory"], caps:{settings:1,delete:1,workers:1,finance:1,receive:1,operate:1,collect:1}},
